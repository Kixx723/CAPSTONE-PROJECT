...
// ang buhatonon dire kay katong sa hamburger menu dapat mo gana
  ...
  return (
    <div className='relative shadow-xl shadow-green-200/40 px-24 py-2'>
      <div className="navbar-container flex items-center justify-between">
        <div className='logo-n-text flex'>
        <img src={logo} alt="logo" className='logo w-16 h-16 2xl:w-20 2xl:h-20'/>
        <h1 className='htc mt-5 ml-2 font-bold text-md 2xl:text-xl 2xl:mt-6'>Holy Trinity College of General Santos City</h1>
        </div>
        <div className='flex items-center space-x-12 font-normal 2xl:text-lg nav-links'>
